/*
 * Dunit OS - virtio-gpu Framebuffer Driver
 * 
...
void fb_show_splash(void)
{
    ...
    /* Simple "Dunit OS" text */
    fb_fill_rect(cx - 60, cy - 30, 120, 60, 0xA6E3A1);
    fb_draw_string(cx - 28, cy - 4, "Dunit OS", 0x1E1E2E, 0xA6E3A1);
    
    /* Boot message */
    fb_draw_string(cx - 86, cy + 50, "Green Tea Desktop System", 0xCDD6F4, 0x1E1E2E);
