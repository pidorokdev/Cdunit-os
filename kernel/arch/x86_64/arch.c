/*
 * Dunit OS Kernel - x86_64 Architecture Implementation
 */
...
{
    /*
     * The x86_64 IDT is still a placeholder in boot.S. Enabling interrupts
     * here lets the first timer IRQ vector through an empty gate and causes a
     * triple fault. Keep IRQs disabled until real IDT setup lands.
     */
    printk(KERN_WARNING "x86_64: IRQ enable skipped (IDT not initialized)\n");
}
