/*
 * Dunit OS - Boot Configuration and Splash Screen
 * 
...
static struct boot_config boot_cfg = {
    ...
    .default_kernel = "/boot/dunitos.elf",
...
void boot_init(void)
{
    ...
    boot_add_entry("Dunit OS", boot_cfg.default_kernel, boot_cfg.kernel_cmdline);
