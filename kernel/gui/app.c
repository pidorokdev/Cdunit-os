/*
 * Dunit OS - Application Framework
 *
...
static void settings_draw(struct application *app) {
  ...
  y += 30;
  gui_draw_string(270, y, "Dunit OS v0.5.0 Green Tea", 0x808080, 0x1E1E2E);
  y += 20;
  gui_draw_string(270, y, "Multiarch Desktop System", 0x808080, 0x1E1E2E);
}
...
static void help_draw(struct application *app) {
  ...
  gui_draw_string(base_x + 10, y, "Dunit OS Help", 0x89B4FA, 0x1E1E2E);
  y += 24;
  ...
  gui_draw_string(base_x + 20, y, "- Type 'help' for commands", 0xCDD6F4,
                  0x1E1E2E);
  y += 16;
  gui_draw_string(base_x + 20, y, "- Type 'dufetch' for system info", 0xCDD6F4,
                  0x1E1E2E);
  y += 24;
  ...
  gui_draw_string(base_x + 10, y, "Copyright 2026 Dunit OS Project", 0x585B70,
                  0x1E1E2E);
}
