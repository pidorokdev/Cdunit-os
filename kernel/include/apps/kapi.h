/*
 * Dunit OS Kernel API for Userspace Applications
 * 
 * IMPORTANT: This structure MUST match user/lib/dunit.h exactly!
...
/* Kernel API structure - must match dunit.h layout! */
typedef struct kapi {
    uint32_t version;
