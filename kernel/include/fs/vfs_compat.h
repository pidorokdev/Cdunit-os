/*
 * Dunit OS VFS Compatibility Layer (DunitOS-style API shim)
 *
 * Provides simple DunitOS-compatible VFS functions on top of Dunit OS's
 * Linux-like VFS. This enables ported DunitOS apps to work.
 */
...
/* Simple DunitOS-style VFS node (wraps our struct file) */
...
/* Simple VFS functions for DunitOS compatibility */
