...
extern const uint8_t dunit_seed_mp3[];
extern const unsigned int dunit_seed_mp3_len;

extern const uint8_t dunit_seed_jpg[];
extern const unsigned int dunit_seed_jpg_len;
