/*
 * Dunit OS Kernel - Kernel Heap Allocator Implementation
 *
 * A simple bucket-based allocator for kernel memory.
 * Fixed to use direct memory region like DunitOS for reliability.
 */
...
void kmalloc_init(void) {
  ...
  /* This is like how DunitOS does it - simple and reliable */
