/*
 * Dunit OS Kernel - Virtual Memory Manager Implementation
 */
...
#ifdef ARCH_X86_64
    /*
     * The generic VMM code below still builds ARM64-style page descriptors.
     * x86_64 enters through boot.S with a valid 4GiB identity map, which is
     * enough for the current kernel, MMIO, and fixed early heap. Keep that
     * bootstrap CR3 active until a native x86_64 VMM is implemented.
     */
    printk("VMM: x86_64 bootstrap identity map active (0-4GB)\n");
    return 0;
#endif
