/*
 * DOOM for DunitOS - libc declarations
...
/* Signed integer types (dunit.h only has unsigned) */
typedef signed char int8_t;
typedef signed short int16_t;
typedef signed int int32_t;
typedef signed long int64_t;

/* Additional types not in dunit.h */
...
#define O_BINARY   0x0000  /* No-op on DunitOS */
